...
| [apt_remote_registries](variables.tf#L17) | Remote artifact registry configurations. | <code>list&#40;object&#40;&#123;&#8230;&#125;&#41;&#41;</code> |  | <code>&#91;&#8230;&#93;</code> |
...
```hcl
module "test" {
  source     = "./fast/project-templates/os-apt-registries"
  project_id = "my-project"
  location   = "europe-west3"
  apt_remote_registries = [
    { path = "DEBIAN debian/dists/bookworm" },
