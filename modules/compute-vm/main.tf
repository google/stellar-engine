...
locals {
  ...
  gpu    = var.gpu != null
  default_compute_scopes = [
    "https://www.googleapis.com/auth/devstorage.read_only",
    "https://www.googleapis.com/auth/logging.write",
    "https://www.googleapis.com/auth/monitoring.write"
  ]
  custom_sa_scopes = ["https://www.googleapis.com/auth/cloud-platform",
    "https://www.googleapis.com/auth/userinfo.email"
  ]
  # default scopes for Compute default SA and for own SA
  sa_scopes = var.service_account.scopes != null ? var.service_account.scopes : (var.service_account.email == null && !var.service_account.auto_create ? local.default_compute_scopes : local.custom_sa_scopes)

  service_account = var.service_account == null ? null : {
    email  = var.service_account.auto_create ? google_service_account.service_account[0].email : var.service_account.email
